...
public class MapControl : MonoBehaviour {    
	...
	void GenerateZoneMonsters()
	{
		...
		currentZone.AddMonster(9,9, ScriptableObject.CreateInstance<BearMonster>());

		currentZone.AddMonster(8,0,ScriptableObject.CreateInstance<WolfMonster>());
		currentZone.AddMonster(8,3,ScriptableObject.CreateInstance<RabbitMonster>());
		currentZone.AddMonster(8,9,ScriptableObject.CreateInstance<RabbitMonster>());
